        ...
        navbar={
          <Navbar width={{ md: 300 }} hiddenBreakpoint="md" hidden={!opened}>
            <Navbar.Section>
              ...
              >
                <Link to="/" style={{ marginTop: 10, padding: 4 }}>
                  <LogoText style={{ height: 22, color: "orange" }} />
                </Link>
            ...
            <Navbar.Section grow component={ScrollArea}>
              ...
              {tab === "Prompts" && <Prompts search={search} onPlay={() => setTab("Chats")} />}
            </Navbar.Section>
            <Navbar.Section sx={{ borderTop: border }} p="xs">
              <Center>
                <ActionIcon size="xl" onClick={() => toggleColorScheme()} title={colorScheme === "dark" ? "Light Mode" : "Dark Mode"}>
                  {colorScheme === "dark" ? "☀" : "🌙"}
                </ActionIcon>
                {/* Social and feedback icons removed for internal branding */}
              </Center>
            </Navbar.Section>
          </Navbar>
        }
